...
describe('Button test', () => {
  ...
  it('should call the correct passed function with the correct props in Controls', () => {
  ...
  it('should call the correct passed function with the correct props in Card', () => {
    renderedButton = shallow(<Button 
                                    name={''}
